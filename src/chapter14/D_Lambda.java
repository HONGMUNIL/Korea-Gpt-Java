...
interface MyFunctionalInterface {
    ...
    //void anotherDoSomeThing(); // @FunctionalInterface는 하나의
    //                           //   추상 메서드만 가진다
}
...
public class D_Lambda {
    public static void main(String[] args) {
        ...
        oneParams.print("안녕"); //출력 메시지 : 안녕

        //4)출력문이 여러줄인 경우 : 중괄호 작성
