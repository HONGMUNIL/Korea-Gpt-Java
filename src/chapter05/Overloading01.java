...
*
* 3. 오버로딩의 단점
* 중복적으로 의미없이 생성한 경우, 실직적으로 필요한 구현 메서드를 찾기에 어려움이 있음(복잡성)*/
...
public class Overloading01 {
    public static void main(String[] args) {
            Calc a = new Calc();
        System.out.println(a.add(10.0, 30)   );
        System.out.println(a.add(10, 20)   );
        System.out.println(a.add(10, 20.0)   );
        System.out.println(a.add(10.5, 20.6)   );
        System.out.println(a.add(10, 30, 30));
