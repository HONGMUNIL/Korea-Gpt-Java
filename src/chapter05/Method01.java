...
/*자바 지향 프로그래밍
        ...
        * 2. methodName(메서드 이름)
        * 메서드를 식별하는 이름
        * 명명 규칙- lowerCamelCase, 권장
        * (권장) 동사를 사용하여 메서드의 작업을 설명
        * EX)먹다 - eat(동사), eating(명사 사용x)
        *
        ...
        * 객체 생성후, 연산자를 통해 호출
        * >> 자바  c# 등 클래스 기반 언어에서 사용됨
        *
        * cf) 자바에서의 '함수'
        * 객체 지향 프로그램인 자바는 모든 함수는 '클래스'에 속해 있어야함
        * */
class Calculator {
    int a,b;
...
public class Method01 {
    public static void main(String[] args) {
      ...
      System.out.println(A.addNumbers(2, 3));

      int result = A.addNumbers(50, 30);
      int result2 = A.addNumbers(23132, 6453654);
