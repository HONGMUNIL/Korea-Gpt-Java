...
public class E_Class_Type {
    public static void main(String[] args) {
        ...
        * 직접 명시 X, 자동으로 타입변환이 일어남
        *
        * 1. 자식객체를 생성하면서 즉시 부모 타입으로 변환하여 저장
        * 부모클래스 객체변수= new 자식클래스();*/
        ...
        // : 두 클래스간의 공통된 특성이 아닌 경우 자식만의 기능은 사용할 수 없다

        /*2. 이미 생성된 객체를 부모타입으로 변환*/
        ...
        *  : 부모 클래스 타입으로 변환된 객체를 다시 자식클래스 타입으로 변환하는것
        * >>자식클래스에만 정의된 멤버에 접근 가능
        *
        * 자식타입 객체변수 = (자식타입) 부모객체;
        * */
