...
class Singleton {
    ...
    public static Singleton getInstance() {
        if (instance == null) {                   //static 필드에 아무런 값이 없다면(한번도 인스턴스화X)
...
class SchoolPrincipal {
    ...
    //1. 생성자를 private로 만들어서 다른 곳에서 객체 생성이 불가하도록 설정

    private SchoolPrincipal() {
        System.out.println("교장선생님 객체가 생성");
    }
    ...
    public void announce() {
        System.out.println("공부 열심히 하시고 운동 열심히하시고 일찍 자고 일찍 일어나세요");
    }
}
...
public class D_SIngleton {
    public static void main(String[] args) {
        ...
        System.out.println(principal2); //chapter13.SchoolPrincipal@49e4cb85  if 조건문보면 똑같음
        System.out.println(principal1 == principal2); //true

        principal1.announce(); //공부 열심히 하시고 운동 열심히하시고 일찍 자고 일찍 일어나세요
