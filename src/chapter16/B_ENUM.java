 ...
 * - 일반적을 상수 선언에 사용되는 static final 보다 더 간결하고 안전한 방식으로 정의
 * - 특정 값들만 가질수 있도록 제한하는 데 사용
 *
 * ----(ENUM 사용법) ----
 * : enum Enum명{ }
...
enum Fruits {
    // enum 내의 데이터는 final 특징을 살려 UPPER_CASE(대문자) 사용
    APPLE, BANANA, ORANGE
}
...
public class B_ENUM {
    public static void main(String[] args) {
        ...
        //ordinal() : Enum 상수의 순서를 반환 ( 0 부터 시작 : APPLE = 0, BANANA = 1, ORANGE = 2)
        //valueOf(String name) : 문자열로 Enum 상수를 반환
        //                  - 잘못된 문자열 전달 시 IllegalArgumentException 발생 대문자도 오류
        // EX)  Fruits orangeFruits =Fruits.valueOf("Orange"); << //IllegalArgumentException
        ...
        System.out.println(orangeFruits.ordinal()); //2
                ...
                //=== CoffeSize 자료형 사용 =====//
        CoffeSize size = CoffeSize.MEDIUM;
