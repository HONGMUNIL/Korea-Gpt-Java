...
// - 주로 데이터베이스에서 데이터를 가져오거나 REST API 통신에서 요청 및 응답 데이터를 담아 전달할 떄 사용

import lombok.AllArgsConstructor;
import lombok.Getter;

//사용자의 아이디와 비밀번호만을 가진 로그인 요청를 가진 DTO
...
//2) VO(Value Object)
//  : 값을 표현하는 객체
//  - 데이터를 담는 용도로 사용, 불변성을 가짐(한번 생성되면 내용 변경이 불가)
// - 주로 필드값을 final 설정
//  - Getter 만을 가짐
@AllArgsConstructor
@Getter
...
//  - 비즈니스 로직에서 데이터베이스의 직접적인 조작없이 데이터를 다룰 수 있게 하는 용도
...
//4) Entity(실제)
// : 데이터 베이스의 테이블에 해당하는 데이터의 구조와 거의 일치하는 클래스
// - JPA(java persistance API)와 같은 ORM(Object-Related Mapping) 툴에서 사용
// - 데이터베이스의 테이블의 레코드와 매핑, 데이터와 비즈니스 로직을 포함
