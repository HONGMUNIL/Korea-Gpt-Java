...
public class B_collect {
    public static void main(String[] args) {
        ...
        //prefix : 접두사
        //suffix : 접미사
        System.out.println(result); //구분자 안쓰면 JAVAPYTHONJAVASCRIPT  //구분자 썻을때 [JAVA,PYTHON,JAVASCRIPT]
