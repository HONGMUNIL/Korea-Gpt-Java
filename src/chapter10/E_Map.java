...
*  - 키는 고유한 데이터를 가짐 ( 중복 키 허용 불가)
*  - 동일한 키에 서로 다른 값을 전달하는 경우 기존 값이 새로운 값으로 덮어 씌워짐
* EX) name: "이승아" 존재한 상태에서 name: "이도경"을 추가하는 경우
*           name의 키에는 "이도경"만이 존재
*
...
public class E_Map {
    public static void main(String[] args) {
        ...
        //values() : Map의 값을 컬렉션 타입으로 반환(List로 반환가능)
        // 컬렉션 타입의 경우 컬렉션 프레임워크들의 상위 집합

        //entrySet(): Map의 키-값을 나타내는 Set을 반환
